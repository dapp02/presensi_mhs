            ...
            <div class="absen-container">
                ...
                <div class="absen-status">
                    <div class="absen-icon">
                        ...
                        <img src="lesson.png" alt="Status Icon">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="absen-container">
                ...
                <div class="absen-status">
                    <div class="absen-icon">
                        ...
                        <img src="academic.png" alt="CRUD Icon">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="kelas-card">
                    ...
                    <div class="kelas-info">
                      <div class="kelas-waktu">
                        <img src="clock.png" class="kelas-icon" />
                        <span>DD, HH:MM - HH:MM</span>
                      </div>
                      <div class="kelas-dosen">
                        <img src="conference.png" class="kelas-icon" />
                        <span>Kelas 2B</span>
                      </div>
                      <div class="kelas-ruang">
                        <img src="classroom.png" class="kelas-icon" />
